...
class ProductSystem:
    ...
    def get_product_list_with_discount(self, models):
        """ Get list of products that have discount """

        products = self.get_product_list(models=models)
    ...
    def get_product_list_by_price(self, min_price, max_price, models):
        """ Sort list by price """

        product_list = self.get_product_list(models=models)
        products = []
    ...
    def get_product_list_by_category(self, category_slug, models):
    ...
    def get_products_by_brand(self, brand_slug, models):
    ...
    def search_products_by_request(self, search_request):
        """ Search products by request """

        products = self.get_products_queryset_by_model(
    ...
    def _get_product(self, kwargs):
        ...
        content_type = self._get_content_type(kwargs=kwargs)
